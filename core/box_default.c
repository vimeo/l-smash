...
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( dovi );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( lhvC );
...
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( SA3D );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( st3d );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( sv3d );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( svhd );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( proj );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( prhd );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( equi );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( cbmp );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( prji );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( vexu );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( eyes );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( must );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( stri );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( hero );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( cams );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( blin );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( cmfy );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( dadj );
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( hfov );
...
DEFINE_SIMPLE_BOX_DEFAULT_CONSTANT( emsg );
